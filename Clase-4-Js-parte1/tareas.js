...
function mesesDelAño(array) {
  ...
  const meses_buscados = ["Enero", "Marzo", "Noviembre"];
  const meses_encontrados = array.filter(mes => meses_buscados.includes(mes));

  return meses_encontrados.length === 3 ? meses_encontrados : "No se encontraron los meses pedidos";
}
